...
<section class="hero">
  ...
  <div class="hero-container">
    ...
    <div class="hero-content">
      ...
      <p class="hero-desc">
        Streamline your computer laboratory operations. Monitor sit-ins, manage
        student sessions, and track resource usage — all in one centralized
        system built for the University of Cebu.
      </p>
        ...
        <div class="stat-card stat-card-main">
          ...
          <div class="session-list">
            <div class="session-item">
              ...
              <span class="session-name">Lab Room 524 — Sit-in</span>
              <span class="session-time">2h 15m</span>
            </div>
            <div class="session-item">
              <span class="session-dot dot-active"></span>
              <span class="session-name">Lab Room 526 — Class</span>
              <span class="session-time">1h 40m</span>
            </div>
            <div class="session-item">
              <span class="session-dot dot-idle"></span>
              <span class="session-name">Lab Room 528 — Idle</span>
              <span class="session-time">0h 05m</span>
            </div>
            <div class="session-item">
              <span class="session-dot dot-vacant"></span>
              <span class="session-name">Lab Room 530 — Vacant</span>
              <span class="session-time">—</span>
            </div>
          </div>
        </div>
        <div class="mini-card">
          <div class="mini-icon"><i class="bi bi-bar-chart-fill"></i></div>
          <div class="mini-info">
  ...
  <div class="section-container">
    <div class="section-header reveal">
      ...
      <p class="section-desc">
        Designed specifically for university computer laboratories, our system
        simplifies day-to-day management tasks.
      </p>
    </div>
...
<section class="how-it-works">
  <div class="section-container">
    <div class="section-header reveal">
      ...
      <p class="section-desc">
        Getting started is straightforward — students and faculty can be up
    ...
    <div class="steps-grid">
      ...
      <div class="step-item reveal">
        ...
        <p class="step-desc">Upon arrival, students log their sit-in session through the system, selecting the lab room and purpose.</p>
      </div>
      <div class="step-item reveal">
        <div class="step-number">03</div>
        <div class="step-label">Work &amp; Track Progress</div>
        <p class="step-desc">The system records your session automatically, tracking time and workstation usage throughout your stay.</p>
      </div>
      <div class="step-item reveal">
...
<section class="stats-banner">
  <div class="section-container">
    <div class="stats-row">
      ...
      <div class="stat-banner-item reveal">
        <div class="stat-banner-num counter" data-target="6">0</div>
